...
#    Updated: 2025/03/14 01:34:13 by dev              ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_CLIENT = src/client.c src/utils.c ft_printf_minitalk/ft_printf.c \
			...
			ft_printf_minitalk/ft_puthex_pf.c
SRC_SERVER = src/server.c src/utils.c ft_printf_minitalk/ft_printf.c \
			ft_printf_minitalk/ft_putchar_pf.c ft_printf_minitalk/ft_putnbr_pf.c ft_printf_minitalk/ft_putstr_pf.c \
			ft_printf_minitalk/ft_puthex_pf.c
...
%.o: %.c includes/minitalk.h ft_printf_minitalk/ft_printf.h
	$(CC) $(CFLAGS) -c $< -o $@
